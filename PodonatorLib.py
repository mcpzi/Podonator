...
def output_images(img1, img2, naming_pattern, file_ext, image_dpi):
    cv.imwrite(naming_pattern+"_G"+file_ext, img1)
    cv.imwrite(naming_pattern+"_D"+file_ext, img2)
    #Adjust image DPI for printing
    im = Image.open(naming_pattern+"_G"+file_ext)
    im.save(naming_pattern+"_G"+file_ext, dpi=(image_dpi,image_dpi))
    im = Image.open(naming_pattern+"_D"+file_ext)
    im.save(naming_pattern+"_D"+file_ext, dpi=(image_dpi,image_dpi))
    return
